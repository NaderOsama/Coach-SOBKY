    ...
    <body>
        ...
        <nav>
            ...
            <ul class="nav__links">
                ...
                <li class="link"><a href="#packkage" class="scroll-to">{{ __('messages.package') }}</a></li>
        ...
        {{-- packages --}}
        <section class="section__container price__container" id="packkage">
            <h2 class="section__header section-heading-title py-5">
                {{ __('messages.discover_our_special_packages') }}
            </h2>
            <p class="section__subheader">
                {{ __('messages.choose_the_right_package_for_you_now_and_let_us_start_together') }}
            </p>
            <div class="price__grid" id="subscribe">
                <div class="price__card">
                <div class="price__card__content">
                    <h3>{{ __('messages.golden_package') }}</h3>
                    <div class="content-list">
                        ...
                        <div class="icon-package">
                            <i class="fa-solid fa-reply"></i>
                            <p>
                                {!! __('messages.organized_nutrition_plan') !!}
                            </p>
                        </div>
                        <div class="icon-package">
                            <i class="fa-solid fa-reply"></i>
                            <p>
                                {!! __('messages.customized_exercise_plan') !!}
                            </p>
                        </div>
                        <div class="icon-package">
                            <i class="fa-solid fa-reply"></i>
                            <p>
                                {!! __('messages.cardio_core_routine') !!}
                            </p>
                        </div>
                        <div class="icon-package">
                            <i class="fa-solid fa-reply"></i>
                            <p>
                                {!! __('messages.stretching_exercise_schedule') !!}
                            </p>
                        </div>
                        <div class="icon-package">
                            <i class="fa-solid fa-reply"></i>
                            <p>
                                {!! __('messages.supplement_guide') !!}
                            </p>
                        </div>
                        <div class="icon-package">
                            <i class="fa-solid fa-reply"></i>
                            <p>
                                {!! __('messages.regular_program_updates') !!}
                            </p>
                        </div>
                        <div class="icon-package">
                            <i class="fa-solid fa-reply"></i>
                            <p>
                                {!! __('messages.exercise_correction') !!}
                            </p>
                        </div>
                        <div class="icon-package">
                            <i class="fa-solid fa-reply"></i>
                            <p>
                                {!! __('messages.bi-weekly_checkups') !!}
                            </p>
                        </div>
                    </div>
                ...
                <button class="btn price__btn joinNow">{{ __('messages.subscribe_now2') }}</button>
                </div>
                <div class="price__card">
                    <div class="price__card__content">
                        <h3>{{ __('messages.platinum_package') }}</h3>
                        <div class="content-list">
                            <div class="icon-package">
                                <i class="fa-solid fa-reply"></i>
                                <p>
                            ...
                            <div class="icon-package">
                                <i class="fa-solid fa-reply"></i>
                                <p>
                                    {!! __('messages.video_call_every_3_weeks') !!}
                        ...
                        <div class="buttons">
                            <button
                                ...
                                onclick="showPriceDetailsPlatinum(3)"
                                >
                                {{ __('messages.three_months') }}
                            </button>
                            <button
                                ...
                                data-months="6"
                                data-package="platinum"
                                onclick="showPriceDetailsPlatinum(6)"
                                >
                                {{ __('messages.six_months') }}
                            </button>
                            <button
                                ...
                                data-months="9"
                                data-package="platinum"
                                onclick="showPriceDetailsPlatinum(9)"
                                >
                                {{ __('messages.nine_months') }}
                            </button>
                        </div>

                        <div id="priceDetailsPlatinum">
                        <!-- Price details will be displayed here -->
                        </div>
                    </div>
                    <button class="btn price__btn joinNow">{{ __('messages.subscribe_now2') }}</button>
                    ...
                    <div class="price__card__content">
                        ...
                        <div class="content-list">
                                ...
                                <div class="icon-package">
                                    <i class="fa-solid fa-reply"></i>
                                    <p>
                                    {!! __('messages.weekly_video_call') !!}
                                    </p>
                                </div>
                                <div class="icon-package">
                                    <i class="fa-solid fa-reply"></i>
                                    <p>
                                    {!! __('messages.attend_training_session') !!}
                                    </p>
                                </div>
                                <div class="icon-package">
                                    <i class="fa-solid fa-reply"></i>
                                    <p>
                                        {!! __('messages.contact_anytime') !!}
                                    </p>
                                </div>
                        </div>
                        <div class="buttons">
                            ...
                            <button
                                ...
                                data-months="9"
                                data-package="vip"
                                onclick="showPriceDetailsVip(9)"
                                >
                                {{ __('messages.nine_months') }}
                            </button>
                        </div>

                        <div id="priceDetailsVip">
                        <!-- Price details will be displayed here -->
                        </div>
                    </div>
                    <button class="btn price__btn joinNow">{{ __('messages.subscribe_now2') }}</button>
